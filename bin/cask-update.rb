...
Dir.foreach(CASKROOM) do |cask_name|
    # Ignore hidden files/directories (i.e. '..' and '.', although someone could potentially have others, such as ".DS_Store" if they've trashed anything there).
    ...
    # Get the list of installed versions from cask directory. As before, ignore any hidden files.
